    ...
    <section className="bg-[#0B2545] text-white py-5 border-y border-[#1E3A5F]">
      <Container size="wide">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 overflow-hidden rounded-xl border border-[#2C4E78] bg-[#102F52] text-center text-xs text-slate-300 sm:grid-cols-2 sm:text-sm lg:grid-cols-3">
